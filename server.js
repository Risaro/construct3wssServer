...
var fa = require("ws").Server,
    f = require("fs"),
    g = "bbq.garagetesla.com",
    k = 443,
    l = "Garagetesla WSS server Construct 3",
    m = "Server by liksa",
    n = "set your multiplayer coonect to wss://bbq.garagetesla.com ",
    ...
    G = "cert.pem";
console.log("*****************************************************".green);
console.log("Construct 3 multiplayer wss server 2.0".green);
console.log("*****************************************************".green);
